...
def main():
    ...
    summarize_results(scores_train, scores_test_1, scores_test_2, scores_test_combined, 'LSTM')


def build_model(n_timesteps, n_features, target_shape, batch_size, epochs):
    def CNN_LSTM_build_model(input_shape: tuple, target_shape: tuple) -> keras.Model:
